...
settings = {"app_id": "Particle", "api_base": args.base_url + "/R4/"}
...
def get_medications():
    ...
    med_url = (
        "MedicationStatement?person="
        + test_person_id
        + "&effective=gt2020-04-29T01:00:00"
    )
...
if __name__ == "__main__":
    ...
    auth = get_auth(args.client_id, args.client_secret, args.base_url)
